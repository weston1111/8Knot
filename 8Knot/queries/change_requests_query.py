...
"""
TODO:
X (2) update 'NAME_query' found in function definition and in the function call that sets the 'ack' variable below.
...
X (6) go to index/index_callbacks.py and import the NAME_query as a unqiue acronym and add it to the QUERIES list
(7) delete this list when completed
"""

QUERY_NAME = "CHANGE_REQUESTS"
...
def change_requests_query(self, repos):
    """
    (Worker Query)
