...
VIZ_ID = "defect-resolution-duration"  # UNIQUE IDENTIFIER FOR VIZUALIZATION

gc_defect_resolution_duration = dbc.Card(
    [
        dbc.CardBody(
            [
                html.H3(
...
def defect_resolution_duration_graph(repolist, interval):
